...
class CabanEnergy(Executor):
    ...
    def fetch_description(self):
        ...
        url = 'https://www.cabanenergy.com/en'
        try:
    ...
    def get_news_details(self):
        """Scrape the latest press/news/blog article from Caban’s site."""
        base = "https://www.cabanenergy.com"
        possible_news_paths = ["/news", "/press-release", "/blog", "/en/news"]
        news_soup = None
        news_url = None
