...
class EverstreamAnalytics(Executor):
    spark = None
    ...
    def get_news_details(self):
        """Scrape the latest press/news/blog article from Everstream’s site."""
        base = "https://www.everstream.ai"
        possible_news_paths = ["/company/media/", "/company/media/"]
        news_soup = None
        news_url = None
